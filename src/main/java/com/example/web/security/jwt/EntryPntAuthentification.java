...
@Component
public class EntryPntAuthentification implements AuthenticationEntryPoint {
    private static final Logger logger = LoggerFactory.getLogger(EntryPntAuthentification.class);
